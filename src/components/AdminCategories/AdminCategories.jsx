...
export default function AdminCategories() {
  ...
  async function handleSend(e) {
    ...
    try {
      await axios
        .post('https://test-heroku-elwood.herokuapp.com/addcategory', value)
        .then(({ data }) => {
          toast.success(data, {
  ...
  const handleSwitchChange = (id) => (e) => {
    ...
    setItemId(id)
    try {
      axios.put('https://test-heroku-elwood.herokuapp.com/editCategory', {
        isChecked: value,
        id: id,
      })
    } catch (error) {
  ...
  async function handleDeleteCategory(id, e) {
    ...
    try {
      await axios.delete(
        `https://test-heroku-elwood.herokuapp.com/deleteCategory/${id}`
      )
